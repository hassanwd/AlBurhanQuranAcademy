export default function TopBar() {
  return (
    <div className="bg-[var(--color-black)] border-b border-[var(--color-gold-muted)] py-2 px-4">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-[var(--color-gray-muted)]">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-1.5 hover:text-[var(--color-gold)] transition-colors"
          >
            <svg className="w-4 h-4 stroke-[var(--color-gold)] fill-none" viewBox="0 0 24 24" strokeWidth="2">
        ...
        <div className="flex items-center gap-3">
          {/* Facebook */}
          <a href="#" aria-label="Facebook" className="text-[var(--color-gray-muted)] hover:text-[var(--color-gold)] transition-colors">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
            </svg>
          </a>
          {/* Instagram */}
          <a href="#" aria-label="Instagram" className="text-[var(--color-gray-muted)] hover:text-[var(--color-gold)] transition-colors">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          {/* LinkedIn */}
          <a href="#" aria-label="LinkedIn" className="text-[var(--color-gray-muted)] hover:text-[var(--color-gold)] transition-colors">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
